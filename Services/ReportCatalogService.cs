...
public class ReportCatalogService
{
    ...
    [
        ...
        Item("sales-journal", "Sales Journal", ReportCategory.Accounting, "Sales journal readiness report.", "/Accounting/Reports/SalesJournal", FinanceRoles),
        Item("purchase-journal", "Purchase Journal", ReportCategory.Accounting, "Purchase journal readiness report.", "/Accounting/Reports/PurchaseJournal", FinanceRoles),
        Item("cash-receipts-journal", "Cash Receipts Journal", ReportCategory.Accounting, "Cash receipts from payments and collections.", "/Accounting/Reports/CashReceiptsJournal", FinanceRoles),
        Item("cash-disbursements-journal", "Cash Disbursements Journal", ReportCategory.Accounting, "Cash disbursement report placeholder.", "/Accounting/Reports/CashDisbursementsJournal", FinanceRoles),
        ...
        Item("sales-invoice-register", "Sales Invoice Register", ReportCategory.PhilippineFinance, "Sales invoice register readiness output.", "/Accounting/Reports/SalesInvoiceRegister", FinanceRoles),
        Item("payment-receipt-register", "Payment Receipt Register", ReportCategory.PhilippineFinance, "Payment receipt register readiness output.", "/Accounting/Reports/PaymentReceiptRegister", FinanceRoles),
        Item("vat-output-summary", "VAT Output Summary", ReportCategory.PhilippineFinance, "Output VAT readiness summary.", "/Accounting/Reports/VATOutput", FinanceRoles),
        Item("vat-input-summary", "VAT Input Summary", ReportCategory.PhilippineFinance, "Input VAT readiness summary.", "/Accounting/Reports/VATInput", FinanceRoles),
        Item("vat-payable-summary", "VAT Payable Summary", ReportCategory.PhilippineFinance, "Output VAT less input VAT.", "/Accounting/Reports/VATPayable", FinanceRoles),
        Item("expanded-withholding-tax-summary", "Expanded Withholding Tax Summary", ReportCategory.PhilippineFinance, "Expanded withholding tax report placeholder.", "/Accounting/Reports/WithholdingTaxSummary", FinanceRoles),
