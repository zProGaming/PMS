...
public class BookingNotificationService(ILogger<BookingNotificationService> logger)
{
    ...
    {
        _logger.LogInformation("Booking request received notification placeholder for {BookingReference}.", bookingRequest.BookingReference);
        return Task.CompletedTask;
    }

    public Task SendBookingConfirmedAsync(BookingRequest bookingRequest)
    {
        _logger.LogInformation("Booking confirmed notification placeholder for {BookingReference}.", bookingRequest.BookingReference);
        return Task.CompletedTask;
    }

    public Task SendBookingCancelledAsync(BookingRequest bookingRequest)
    {
        _logger.LogInformation("Booking cancelled notification placeholder for {BookingReference}.", bookingRequest.BookingReference);
        return Task.CompletedTask;
    }
}
