...
{
    /// <inheritdoc />
    public partial class AddFoodBeveragePosMvp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OutletType = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiningTables_Outlets_OutletId",
                        column: x => x.OutletId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSOrders_DiningTables_DiningTableId",
                        column: x => x.DiningTableId,
                        principalTable: "DiningTables",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_POSOrders_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_POSOrders_Outlets_OutletId",
                        column: x => x.OutletId,
                        principalTable: "Outlets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_POSOrders_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSOrderItems_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSOrderItems_MenuItemId",
                table: "POSOrderItems",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSOrders_DiningTableId",
                table: "POSOrders",
                column: "DiningTableId");

            migrationBuilder.CreateIndex(
                name: "IX_POSOrders_GuestId",
                table: "POSOrders",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_POSOrders_OutletId",
                table: "POSOrders",
                column: "OutletId");

            migrationBuilder.CreateIndex(
                name: "IX_POSOrders_ReservationId",
                table: "POSOrders",
